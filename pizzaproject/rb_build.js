...
/* Constructor function for individal food items */
function foodItem() {
   this.price;
   this.qty;
}
...
pizza.prototype.calcPizzaPrice = function() {
   ...
   for (var i = 0; i < this.toppings.length; i++) {
      ...
      this.price += this.toppings[i].side*1.50;
   }
...
window.addEventListener("load", function() {
   ...
   function addPizzaToCart() { 
      ...
      priceCell.textContent = (myPizza.qty*myPizza.calcPizzaPrice()).toLocaleString('en-US', {style: "currency", currency: "USD"});
